...
print("My favorite book is \(favoriteBook.title) by \(favoriteBook.author) and I paid $\(favoriteBook.price) for it and it has \(favoriteBook.pages) pages.")
/*:
...
let laptop1 = Laptop(screenSize: 16, repairCount: 2, yearPurchased: 2024)
let laptop2 = Laptop(yearPurchased: 2020)
/*:
...
print("My height in centimeters is: \(myHeight.heightInCentimeters)")
print("My height in inches is: \(myHeight.heightInInches)")
/*:
