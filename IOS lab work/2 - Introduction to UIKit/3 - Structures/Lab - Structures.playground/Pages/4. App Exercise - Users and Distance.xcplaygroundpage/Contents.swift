...
var navdeep = User(name: "Navdeep", age: 25, height: 178, weight: 75, activityLevel: 7)
print("\(navdeep.name) is \(navdeep.age) years old, \(navdeep.height) cm tall, weighs \(navdeep.weight) kg and is level \(navdeep.activityLevel)/10 active")
/*:
