...
// The above print statement will produce a compile error as var foo's scope only extends to the end of the for loop.
...
// The above print statements will compile as var x is declated in the global scope and thereforeaccessable to all functions.
