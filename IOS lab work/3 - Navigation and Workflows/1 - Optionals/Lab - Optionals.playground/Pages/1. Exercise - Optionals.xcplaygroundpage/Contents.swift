...
// userAge is nil because "34e" is not a valid integer string, so Int("34e") fails.
 ...
 */
let fixedUserInputAge: String = "34"
let userAgeFixed: Int? = Int(fixedUserInputAge)
print(userAgeFixed!)  // Force unwrapping, will print: 34


//:  Now use optional binding to unwrap `userAge`. If `userAge` has a value, print it to the console.
if let unwrappedAge = userAgeFixed {
    print("The user's age is \(unwrappedAge)")
}
